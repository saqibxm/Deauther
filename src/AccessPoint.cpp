...
AccessPoint::AccessPoint(bool hidden, const char* ssid, byte* bssid, int rssi, byte enc, byte ch) {
    this->hidden = hidden;
...
const byte* AccessPoint::getBSSID() const {
    return bssid;
}
...
byte AccessPoint::getChannel() const {
    return ch;
}
...
int AccessPointList::compare(const AccessPoint* ap, const byte* bssid) const {
...
bool AccessPointList::push(bool hidden, const char* ssid, byte* bssid, int rssi, byte enc, Channel ch) {
...
AccessPoint* AccessPointList::search(const byte* bssid) {
